...
**Google Guice** (mit der `scala-guice` Erweiterung)

### Konfiguration (Module)
In `wizard.WizardModule` wird beispielsweise festgelegt, ob das Spiel XML oder JSON zur Speicherung verwenden soll.
